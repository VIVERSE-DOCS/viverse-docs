...
4. [Multiplayer](docs/multiplayer.md) — Matchmaking, game room, modules  
...
## What to put in this folder for GitHub

Place the distributable **`.unitypackage`** files here (names may match your releases):

| Package | Typical filename | Main purpose |
|--------|-------------------|--------------|
...
Details: [Multiplayer](docs/multiplayer.md).
